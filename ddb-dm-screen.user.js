...
function addGUI() {
    ...
    $('input[name ="gs-auto-update"]').change(function(){GM_setValue("ddbDmScreen-autoupdate", $(this).prop("checked"));});
    $('input[name ="auto-duration"]').change(function(){GM_setValue("ddbDmScreen-updateSeconds", $(this).val());});
