...
function render(character, node){ // function that builds the scraped data and renders it on the page.
  ...
  var abilityHTML = `
	<div class="gs-able-container gs-container gs-flex-items">
	  <div class="gs-label gs-able-label"></div>
	  <div class="gs-value gs-able-value">
	    <span class="gs-number gs-able-number"></span>
	    <span class="gs-mod gs-able-mod"> (<span class="gs-sign gs-able-mod-sign"></span><span class="gs-number gs-able-mod-value"></span>)</span>
      </div>
    </div>
  `; //removed gs-flex-values
  
  var savingThrowsHTML = `
	<div class="gs-main-saves gs-container gs-flex-items">
	  <div class="gs-label gs-saves-label"></div>
	  <div class="gs-value gs-saves-value">
	    <span class="gs-sign gs-saves-sign"></span> <span class="gs-number gs-saves-number"></span>
      </div>
    </div>
  `; //removed gs-flex-values
...
function prerender(character, node, times) { //Prerender logic - needs to be commented further
    if (!isNaN(character.ac)) {
        ...
        times += 1;
        if (times < 80) {setTimeout(function() {
			prerender(character, node, times);}, 500);
		} else {
