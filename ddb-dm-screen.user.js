...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  //---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	hpContainer
		...
		.append($('<div/>',	{class: "gs-hp-box"	}));

	var hpBox = hpContainer.children('.gs-hp-box');
	hpBox
		.append($('<div/>', { class: "gs-box-background", html: otherBoxSVG }))
		.append($('<div/>',	{class: "gs-hp-value"}))
	var healthValue= hpBox.children('.gs-hp-value');
	healthValue
		.append($('<span/>',	{class: "gs-hp-cur",		html: character.currentHP}))
		//.append($('<span/>',	{class: "gs-hp-sep", 		html: "/"}))
		.append($('<span/>', 	{class: "gs-hp-max",		html: "(" + character.maxHP + ")"}));
	...
	intvContainer
		...
		.append($('<div/>',	{class: "gs-intv-box gs-flex-items"	}));

	var intvBox = intvContainer.children('.gs-intv-box');
	intvBox
		.append($('<div/>', { class: "gs-box-background", html: initiativeBoxSVG }))
		.append($('<div/>',	{class: "gs-intv-value gs-flex-values"}))
	var intvValue= intvBox.children('.gs-intv-value');
	intvValue
		.append($('<span/>',	{class: "gs-intv-sign",		html: character.initiative.sign}))
		.append($('<span/>', 	{class: "gs-intv-number",	html: character.initiative.number}));
